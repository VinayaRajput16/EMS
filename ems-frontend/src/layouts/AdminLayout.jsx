      ...
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1">
          {navItems.map((item) => (
            ...
            >
              <span className={isActive(item.to) ? "text-indigo-600" : "text-slate-400"}>
                {item.icon}
              </span>
        ...
        <div className="px-4 py-4 border-t border-slate-200">
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-50 transition-colors cursor-pointer">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full flex items-center justify-center">
              <span className="text-sm font-semibold text-indigo-700">A</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-slate-900 truncate">Admin User</p>
              <p className="text-xs text-slate-500 truncate">admin@eventhub.com</p>
            </div>
